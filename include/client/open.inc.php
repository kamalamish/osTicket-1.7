...
?>
<h1><?= _('Open a New Ticket') ?></h1>
<p><?= _('Please fill in the form below to open a new ticket.') ?></p>
<form id="ticketForm" method="post" action="open.php" enctype="multipart/form-data">
  <?php csrf_token(); ?>
  <input type="hidden" name="a" value="open">
  <table width="800" cellpadding="1" cellspacing="0" border="0">
    <tr>
        <th class="required" width="160"><?= _('Full Name:') ?></th>
        <td>
            <?php
            if($thisclient && $thisclient->isValid()) {
    ...
    <tr>
        <th class="required" width="160"><?= _('Email Address:') ?></th>
        <td>
            <?php
            if($thisclient && $thisclient->isValid()) { 
    ...
    <tr>
        ...
        <td>
            ...
            <label for="ext" class="inline"><?= _('Ext.:') ?></label>
    ...
    <tr>
        <td class="required"><?= _('Subject:') ?></td>
        <td>
    ...
    if($cfg && $cfg->isCaptchaEnabled() && (!$thisclient || !$thisclient->isValid())) {
        ...
        ?>
    <tr class="captchaRow">
        <td class="required"><?= _('CAPTCHA Text:') ?></td>
        <td>
            <span class="captcha"><img src="captcha.php" border="0" align="left"></span>
            &nbsp;&nbsp;
            <input id="captcha" type="text" name="captcha" size="6">
            <em><?= _('Enter the text shown on the image.') ?></em>
  ...
  <p style="padding-left:150px;">
        ...
        <input type="button" value="<?= _('Cancel') ?>" onClick='window.location.href="index.php"'>
  </p>
</form>
