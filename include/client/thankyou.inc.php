...
<div style="margin:5px 100px 100px 0;">
    ...
    <p>
     <?= _('Thank you for contacting us.')?><br>
     <?= _('A support ticket request has been created and a representative will be getting back to you shortly if necessary.')?></p>
          
    <?php if($cfg->autoRespONNewTicket()){ ?>
    <p><?= _('An email with the ticket number has been sent to')?> <b><?php echo $ticket->getEmail(); ?></b>.
        <?= _('You\'ll need the ticket number along with your email to view status and progress online.')?> 
    </p>
    <p>
