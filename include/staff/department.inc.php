    ...
    <thead>
        <tr>
            <th colspan="2">
                ...
                <em><?= _('Department Information') ?></em>
            </th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="radio" name="ispublic" value="0" <?php echo !$info['ispublic']?'checked="checked"':''; ?>><strong><?= _('Private') ?></strong><?= _('(Internal)') ?>
        ...
        <tr>
            ...
            <td>
                <select name="email_id">
                    <option value="0">&mdash;<?= _('Select Department Email') ?> &mdash;</option>
                    <?php
        ...
        <tr>
            ...
            <td>
                ...
                <?= _('Extend membership to groups with access.') ?> <i><?= _('(Alerts and  notices will include groups)') ?></i>
            </td>
        </tr>
        <tr>
            <th colspan="2">
        ...
        <tr>
            ...
            <td>
                ...
                <strong><?= _('Disable')?></strong><?= _(' new ticket auto-response for this Dept.')?>
            </td>
        </tr>
        <tr>
            <td width="180">
        ...
        <tr>
            <td width="180">
                <?= _('Auto Response Email')?>:
            </td>
            <td>
                <select name="autoresp_email_id">
                    <option value=""  disabled="disabled"><?= _('Select Outgoing  Email')?></option>
                    <option value="0">&mdash;<?= _(' Department Email (Above)')?> &mdash;</option>
                    <?php
                    $sql='SELECT email_id,email,name FROM '.EMAIL_TABLE.' email ORDER by name';
                    if(($res=db_query($sql)) && db_num_rows($res)){
                        while(list($id,$email,$name)=db_fetch_row($res)){
        ...
        <tr>
            <th colspan="2">
                <em><strong><?= _('Department Access')?></strong>:<?= _(' Check all groups allowed to access this department.')?></em>
            </th>
        </tr>
        <tr><td colspan=2><em><?= _('Department manager and primary members will always have access independent of group selection or assignment.')?></em></td></tr>
        <?php
        ...
        <tr>
            <th colspan="2">
                <em><strong><?= _('Department Signature')?></strong>:<?= _(' Optional signature used on outgoing emails.')?> &nbsp;<span class="error">&nbsp;<?php echo $errors['signature']; ?></span></em>
            </th>
        </tr>
        <tr>
            <td colspan=2>
                <textarea name="signature" cols="21" rows="5" style="width: 60%;"><?php echo $info['signature']; ?></textarea>
                <br><em><?= _('Signature is made available as a choice, for public departments, on ticket reply.')?></em>
            </td>
        </tr>
    </tbody>
</table>
<p style="padding-left:225px;">
    ...
    <input type="button" name="cancel" value="<?= _('Cancel')?>" onclick='window.location.href="departments.php"'>
</p>
</form>
