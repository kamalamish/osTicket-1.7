...
?>
<h2><?= _('Email Template Message') ?> - <span><?php echo $template->getName(); ?></span></h2>
   ...
   <thead>
     <tr>
        <th colspan="2">
            ...
            <em><?= _('Subject and body required.') ?> <a class="tip" href="ticket_variables.txt"><?= _('Supported Variables') ?></a>.</em>
        </th>
     </tr>
    </thead>
    <tbody>
        <tr>
            <td colspan=2>
                <strong><?= _('Message Subject') ?>:</strong> <em><?= _ ('Email message subject') ?></em> <font class="error">*&nbsp;<?php echo $errors['subj']; ?></font><br>
                <input type="text" name="subj" size="60" value="<?php echo $info['subj']; ?>" >
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <strong><?= _('Message Body') ?>:</strong> <em><?= _('Email message body') ?>.</em> <font class="error">*&nbsp;<?php echo $errors['body']; ?></font><br>
...
<p style="padding-left:210px;">
    ...
    <input class="button" type="button" name="cancel" value="<?= _('Cancel Changes') ?>" onclick='window.location.href="templates.php?id=<?php echo $template->getId(); ?>"'>
</p>
</form>
